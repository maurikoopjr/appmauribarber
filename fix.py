...
def fix():
    path = "C:/Users/mauri koop junior/.gemini/antigravity/scratch/barbearia_deploy/app.js"
    with open(path, "r", encoding="utf-8") as f:
        content = f.read()

    start_str = """// Chamar ao iniciar a aplicação
document.addEventListener("DOMContentLoaded", function() {
    carregarConfiguracaoVisual();
});"""
    end_str = "function adicionarItemComanda(tipo, id, nome, preco) {"
...
"""
    ...
    new_content = content[:start_idx] + chunk + "\n" + content[end_idx:]
